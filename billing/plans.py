...
PLANS: tuple[AccessPlan, ...] = (
    AccessPlan(
        ...
        currency="USD",
        period_days=3,
        headline="Start publishing with a tiny first pass",
        description="Three days to unlock downloads, test the core tools, create drafts and see the full workflow.",
        features=(
            "All core tools included",
            "Light storage and smaller files",
            "Download ready results",
            "A clean low-risk start",
        ),
